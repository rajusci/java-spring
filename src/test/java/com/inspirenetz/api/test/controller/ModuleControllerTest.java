...
public class ModuleControllerTest {
    ...
    private static Logger log = LoggerFactory.getLogger(ModuleControllerTest.class);
    ...
    public void saveModule() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(post("/api/0.9/json/admin/module")
                                                .principal(principal)
                                                .session(session)
                                                .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                                                .param("mdlName", module.getMdlName())
                                                .param("mldComment",module.getMdlComment())
                                                .param("setMdlDefaultEnabled", module.getMdlDefaultEnabled().toString())
                                              )
                                        .andReturn();
        String response = mvcResult.getResponse().getContentAsString();
        Assert.assertNotNull(response);
        log.info("ModuleResponse: " + response);
    ...
    public void deleteModule() throws  Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(post("/api/0.9/json/admin/module/delete/" + module.getMdlId())
                                                    .principal(principal)
                                                    .session(session)
                                                    .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                                            )
    ...
    public void listModules() throws Exception  {
        ...
        // Place the delete request
        MvcResult mvcResult = mockMvc.perform(get("/api/0.9/json/admin/modules/0/0")
                .principal(principal)
                .session(session)
                .contentType(MediaType.APPLICATION_FORM_URLENCODED)
    ...
    public void getModuleInfo() throws Exception  {
        ...
        // Place the delete request
        MvcResult mvcResult = mockMvc.perform(get("/api/0.9/json/admin/module/"+module.getMdlId())
                .principal(principal)
                .session(session)
                .contentType(MediaType.APPLICATION_FORM_URLENCODED)
        )
